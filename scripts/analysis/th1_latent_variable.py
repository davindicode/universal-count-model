binsize = 100
rcov_lvm, neurons, tbin, resamples, rc_t, _ = HDC.get_dataset(
    session_id, phase, binsize, "../scripts/data"
)
...
for mode in modes:
    ...
    for rn in CV:
        ...
        drift, sign, shift, losses = circ_drift_regression(
            tar_t[fit_range],
            lat[fit_range],
            fit_range * tbin,
            topology,
...
data_run = (lat_t, lat_t_std, delay_RMS, RMS_cv, LVM_cv_ll, drifts_lv, rcov_lvm)
